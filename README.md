...
<div align="center">
  <table>
    <tr>
      <td align="center"><strong><a href="https://github.com/PlayTheApp">박준영</a></strong></td>
      <td align="center"><strong><a href="https://github.com/haesookimDev">김해수</a></strong></td>
      <td align="center"><strong><a href="https://github.com/HwangSedong">황세동</a></strong></td>
      <td align="center"><strong><a href="https://github.com/Janghyeonsuk">장현석</a></strong></td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="center">기획, 디자인, 개발</td>
      <td align="center">기능 구현, 테스트</td>
      <td align="center">서버 개발</td>
      <td align="center">서버 개발</td>
    </tr>
  </table>
</div>  
...
|구분|기술 스택|
|:---|:---:|
|**프론트엔드**|![Flutter](https://img.shields.io/badge/Flutter-%2302569B.svg?style=for-the-badge&logo=Flutter&logoColor=white) (Dart >=2.18.6 <3.0.0) |
...
| 근처에 획득하지 못한 명소가 존재한다면, 해당 경위도로 마커를 찍습니다. | 공통 아이템 또는 지역 아이템을 획득합니다. | 상호작용 등 다양한 사건들이 발생합니다. |
...
| 게임머니를 소비해서 TG/EXP/아이템을 획득합니다. | (일일 1회) 걸음 수를 채우면 보상을 획득합니다. |
